Sidebar.IkBasic=function(ap){
	...
	ap.getSignal("ikSettingChanged").add(function(){
		minAngle.setValue(IkUtils.minAngle);
		maxAngle.setValue(ap.ikControler.maxAngle);
		iteration.setValue(ap.ikControler.iteration);
		followOtherIkTargets.setValue(ap.ikControler.followOtherIkTargets);
	});
