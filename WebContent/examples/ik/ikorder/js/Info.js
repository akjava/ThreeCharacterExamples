...
var Info = function ( application ) {
	...
	var orderText = new UI.Text( '' ).setMarginLeft( '6px' );
	...
	var orderText2 = new UI.Text( '' ).setMarginLeft( '6px' );
	...
	var orderText3 = new UI.Text( '' ).setMarginLeft( '6px' );
	...
	var orderText4 = new UI.Text( '' ).setMarginLeft( '6px' );
	...
	container.add( new UI.Break());
	container.add( new UI.Text( 'order:' ), orderText, new UI.Break() );
	...
	container.add( new UI.Break());
	container.add( new UI.Text( 'order:' ), orderText2, new UI.Break() );
	...
	container.add( new UI.Break());
	container.add( new UI.Text( 'order:' ), orderText3, new UI.Break() );
	...
	container.add( new UI.Break());
	container.add( new UI.Text( 'order:' ), orderText4, new UI.Break() );
	...
	function update() {
		...
		if(!ikName==""){
			...
			orderText.setValue(bone.rotation.order);
			...
			orderText2.setValue(bone.rotation.order);
			var rotX=THREE.Math.radToDeg(bone.rotation.x).toFixed(2);
			...
			if(ap.ikControler.ikIndices.length>=4){
				...
				orderText3.setValue(bone.rotation.order);
				var rotX=THREE.Math.radToDeg(bone.rotation.x).toFixed(2);
			...
			if(ap.ikControler.ikIndices.length>=5){
				...
				orderText4.setValue(bone.rotation.order);
				var rotX=THREE.Math.radToDeg(bone.rotation.x).toFixed(2);
