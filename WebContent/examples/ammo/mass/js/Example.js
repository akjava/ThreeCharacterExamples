...
Example.newBall=function(application){
	...
	if(application.ball2!=null){
		application.ammoControler.destroyBodyAndMesh(application.ball2);
	}
	application.ball2=application.ammoControler.createBox(new THREE.Vector3(2, 2, 2), 1, 0, 0, -65, 
...
Example.createBox=function(application){
	 var bm=application.ammoControler.createBox(new THREE.Vector3(2, 2, 2), application.ballMass, 0,application.ballStartY, -79, 
