var Sidebar = function ( application ) {
	...
	container.add(new UI.AppName("Simple Bodies"));
	...
	var list=new UI.List(["Box","Sphere","Capsule","Cylinder","Cone"],function(type){
		application.ballType=type;
	});
	ballRow.add(list);
