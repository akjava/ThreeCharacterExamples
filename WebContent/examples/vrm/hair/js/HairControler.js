...
HairControler.prototype.initialize=function(ammoControler,boneAttachControler){
	var scope=this;
...
HairControler.prototype.addLink=function(links){
	var scope=this;
...
HairControler.prototype.findSphereByName=function(name){
	var match=null;
...
HairControler.prototype.createSphereBox=function(size,mass,position,isRoot){
...
HairControler.prototype.makeConstraint=function(box1,box2){
...
HairControler.prototype.setEnabled=function(v){
	this._enabled=v;
}

HairControler.prototype._destroyHair=function(){
	var scope=this;
...
HairControler.prototype.dispose=function(){
	 this._destroyHair();
	 if(this.headBox){
...
/*HairControler.prototype.getDistance=function(isBreastR){
...
HairControler.prototype.update=function(){
	if(!this._enabled){
		return;
	}
/*	var scope=this;
...
HairControler.prototype.updateSpringValues=function(){
	this.setSpringValues(this.stiffness,this.damping,this.bodyDamping);
}
HairControler.prototype.setSpringValues=function(stiffness,damping,bodyDamping){
	function change(box){
...
HairControler.prototype.newHair=function(){
	...
	var scope=this;
	 ...
	 this.ammoControler.printCount();
		...
		var linkGroups=[];
		linkGroups.push(["hair1_R","hair2_R","hair3_R","hair4_R","hair5_R","hair6_R","hair7_R","hair8_R"]);//])//
		linkGroups.push(["hair1_L","hair2_L","hair3_L","hair4_L","hair5_L","hair6_L","hair7_L","hair8_L"]);//])//
		linkGroups.push(["hair_01_01","hair_01_02"]);
		linkGroups.push(["hair_02_01","hair_02_02"]);
		linkGroups.push(["hair_03_01","hair_03_02"]);
