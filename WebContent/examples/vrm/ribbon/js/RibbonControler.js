...
RibbonControler.prototype.initialize=function(ammoControler,boneAttachControler){
	...
	var sprine03=BoneUtils.findBoneIndexByEndsName(boneList,"head");
	var breastR=BoneUtils.findBoneIndexByEndsName(boneList,"ribbon_R");
	this.breastR=breastR;
	var breastL=BoneUtils.findBoneIndexByEndsName(boneList,"ribbon_L");
	...
	var sprine03Box=this.ammoControler.createBox(new THREE.Vector3(5, 5, 5), 0, 0,0,0, 
...
RibbonControler.prototype.setEnabled=function(v){
	this._enabled=v;
}


RibbonControler.prototype._destroyBreast=function(){
	var scope=this;
...
RibbonControler.prototype.dispose=function(){
...
RibbonControler.prototype.resetPosition=function(){
	var scope=this;
	function reset(box){
...
RibbonControler.prototype.getDistance=function(isBreastR){
...
RibbonControler.prototype.update=function(){
	if(!this._enabled){
		return;
	}
	var scope=this;
...
RibbonControler.prototype.updateSpringValues=function(){
	this.setSpringValues(this.stiffness,this.damping,this.bodyDamping);
}
RibbonControler.prototype.setSpringValues=function(stiffness,damping,bodyDamping){
	function change(box){
...
RibbonControler.prototype.newBreast=function(){
...
RibbonControler.prototype.createBreastBox=function (breastContainer,targetBone,opposite){
