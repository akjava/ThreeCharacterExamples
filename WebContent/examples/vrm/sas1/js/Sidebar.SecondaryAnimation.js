Sidebar.SecondaryAnimation=function(ap){
	var panel=new UI.TitlePanel("Ammo SecondaryAnimation4S1");
	
	
	ap.secondaryAnimationControler=new SecondaryAnimationControler(ap);
	ap.secondaryAnimationControler.scale=1;
	ap.secondaryAnimationControler.baseHitRadius=1;
	ap.secondaryAnimationControler.baseStiffiness=2;
	ap.secondaryAnimationControler.mass=0.01;
	ap.secondaryAnimationControler.minSize=0.5/100;
...
var buttonRow=new UI.ButtonRow("Step",function(){
	...
	var secondaryAnimationSize=new UI.NumberButtons("baseHitRadius",0.01,100,1,ap.secondaryAnimationControler.baseHitRadius,function(v){
	...
	var stiffness=new UI.NumberButtons("baseStiffiness",0,100,1,ap.secondaryAnimationControler.baseStiffiness,function(v){
